...
Neither line records what changed in the **methodology**. A repository declares the methodology version it follows in `spx.config.yaml`, and `spx` reads and enforces that declaration.
