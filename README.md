...
| Skill | `/merging-standards`          | Merge-lifecycle standards for pre-flight predicates, branch topology, push commands, authority gates, review classification, integration review surfaces, action tokens, delivered-value boundaries, closeout, and repo-local overlays                                                                                            |
| Skill | `/open-pr`                    | PR opening protocol for VERIFICATION_READINESS, explicit branch publication, topology-appropriate pull-request state, and lifecycle handoff                                                                                                                                                                                       |
