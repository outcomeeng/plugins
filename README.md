...
| Skill | `/subagent-standards`     | Claude: Configuration, configuration-subject, profile, capability, invocation, placement, and evidence standards for subagents; Codex: Configuration, configuration-subject, profile, capability, invocation, placement, and evidence standards for custom agents                                         |
