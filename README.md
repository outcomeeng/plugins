...
| Skill | `/update-instruction-block` | Manually regenerating, refreshing, or scaffolding a product's root CLAUDE.md and AGENTS.md managed Spec Tree instruction surface from the installed spec-tree template, or reconciling a command slot that differs between the two files                                                                                                                    |
