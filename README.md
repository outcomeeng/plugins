...
| Type  | Name                    | Purpose                                                                                                                                                    |
| ----- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Skill | `/coding-agents-plugin` | Operate the coding-agents plugin's own lifecycle in a checkout                                                                                             |
...
| Type  | Name                      | Purpose                                                                                           |
| ----- | ------------------------- | ------------------------------------------------------------------------------------------------- |
| Skill | `/contribute-plugin`      | Operate the contribute plugin's own lifecycle in a checkout                                       |
...
| Skill | `/open-parent-issue`      | Filing an issue in a repository the operator does not control                                     |
| Skill | `/open-parent-pr`         | Opening a pull request against a repository the operator does not control                         |
...
| Skill | `/frontend-plugin` | Operate the frontend plugin's own lifecycle in a checkout  |
...
| Type  | Name                    | Purpose                                                                                          |
| ----- | ----------------------- | ------------------------------------------------------------------------------------------------ |
| Skill | `/hdl-plugin`           | Operate the hdl plugin's own lifecycle in a checkout                                             |
...
| Skill | `/instructions-plugin`    | Operate the instructions plugin's own lifecycle in a checkout                                                                                                                                                                                                                                             |
...
| Skill | `/author-prose`                 | Writing text for human readers                                     |
| Skill | `/prose-architecture-standards` | Prose ADR conventions enforced across architect and auditor skills |
| Skill | `/prose-plugin`                 | Operate the prose plugin's own lifecycle in a checkout             |
...
| Skill | `/python-plugin`                 | Operate the python plugin's own lifecycle in a checkout             |
...
| Skill | `/rust-plugin`                 | Operate the rust plugin's own lifecycle in a checkout                                                                           |
...
Spec Tree methodology for declaration, context loading, evidence, implementation, review, sessions, and delivery
...
| Skill | `/changeset-scope-standards`          | Changeset-scope standards enforced across verification and lifecycle skills                                                                                                                                                                 |
...
| Skill | `/handoff`                            | ALWAYS invoke to close active spec-tree work or a merge lifecycle closeout                                                                                                                                                                  |
| Skill | `/init-worktrees`                     | Setting up a repository's git worktree layout                                                                                                                                                                                               |
...
| Skill | `/issue`                              | Filing a follow-up into the owning repository's session queue                                                                                                                                                                               |
...
| Skill | `/spec-tree-plugin`                   | Operate the spec-tree plugin's own lifecycle in a checkout                                                                                                                                                                                  |
| Skill | `/sync-base`                          | Bring a branch behind its base current                                                                                                                                                                                                      |
| Skill | `/task-tracking-standards`            | Runtime task-tracking standards for skills that schedule heartbeats or timers                                                                                                                                                               |
| Skill | `/test-evidence-standards`            | Test-evidence seam, case-provenance, oracle-independence, execution-level, and per-assertion-type artifact-permission standards enforced across test authoring and auditing                                                                 |
...
| Skill | `/verification-run-journal-standards` | Verification run-journal projection standards enforced across audit and review skills                                                                                                                                                       |
...
| Agent | `instruction-block-updater`           | Applying spec-tree template drift to a product's root CLAUDE.md and AGENTS.md managed instruction block in the background                                                                                                                   |
...
| Skill | `/typescript-plugin`                 | Operate the typescript plugin's own lifecycle in a checkout                                                                   |
...
| Skill | `/sanitize-powerpoint` | Sanitizing, cleaning up, auditing, or aligning a PowerPoint (.pptx) deck        |
| Skill | `/work-plugin`         | Operate the work plugin's own lifecycle in a checkout                           |
