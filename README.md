...
| Skill   | `/audit-adr`             | Asked by the user to invoke the ADR audit skill                                                                                                                                                                                                                                                                                              |
| Skill   | `/audit-pdr`             | Asked by the user to invoke the PDR audit skill                                                                                                                                                                                                                                                                                              |
...
| Skill   | `/handoff`               | Closing an in-scope spec-tree session, deciding whether to create a handoff, writing a handoff, or preparing continuation context                                                                                                                                                                                                            |
...
| Skill   | `/pr`                    | The user asks to open a PR, ship a change, or take work from changes to merged, or runs /pr                                                                                                                                                                                                                                                  |
...
| Command | `/open-pr`               | Open a ready PR for the current branch with curated title and body                                                                                                                                                                                                                                                                           |
