...
| Skill | `/select-artifacts`           | The registered artifacts and audit skills each changed path selects, resolved through the artifact registry the build renders beside this skill's reader                                                                                                                                                                                                        |
