...
| Skill | `/audit-python-tests`            | Python test-evidence audit methodology composed by the dispatched test-evidence-auditor for the Python tests in scope                                               |
...
| Skill | `/audit-rust-tests`            | Rust test-evidence audit methodology composed by the dispatched test-evidence-auditor for the Rust tests in scope                                                         |
...
Spec Tree: /understand, /contextualize, /bootstrap, /author, /decompose, /refactor, /align, /interview, /test, /audit-tests, /audit-eval-evidence, /audit-adr, /audit-pdr, /apply, /commit-changes, /handoff, /pickup, /refocus, /diagnose, /issue
...
| Skill | `/audit-typescript-tests`            | TypeScript test-evidence audit methodology composed by the dispatched test-evidence-auditor for the TypeScript tests in scope                                               |
