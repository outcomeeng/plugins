...
Instruction authoring: /create-skills, /create-subagents
...
| Skill | `/audit-python-tests`            | Python test-evidence audit methodology composed by a dispatched test-evidence-auditor or implementation-auditor for the Python tests in scope                       |
...
| Skill | `/audit-rust-tests`            | Rust test-evidence audit methodology composed by a dispatched test-evidence-auditor or implementation-auditor for the Rust tests in scope                                 |
...
| Skill | `/audit-adr`                | ADR audit methodology used by the adr-auditor agent                                                                                                                                                                                                                                                                                                         |
| Skill | `/audit-eval-evidence`      | Eval-evidence audit methodology preloaded by the eval-evidence-auditor agent                                                                                                                                                                                                                                                                                |
| Skill | `/audit-implementation`     | Implementation-audit orchestration methodology used by the implementation-auditor agent                                                                                                                                                                                                                                                                     |
| Skill | `/audit-pdr`                | PDR audit methodology used by the pdr-auditor agent                                                                                                                                                                                                                                                                                                         |
| Skill | `/audit-specs`              | Spec-node audit methodology used by the spec-auditor agent                                                                                                                                                                                                                                                                                                  |
| Skill | `/audit-tests`              | Test-evidence audit methodology used by the test-evidence-auditor agent                                                                                                                                                                                                                                                                                     |
...
| Skill | `/merging-standards`        | Shared vocabulary for the merge lifecycle — pre-flight predicates, branch topology gate, push command, authority gates, review classification, integration review surfaces, action tokens, delivered-value boundary, closeout, and repo-local overlay topics                                                                                                |
...
| Skill | `/scope-changeset`          | Canonical changeset-scope primitives composed by verification and merge workflows                                                                                                                                                                                                                                                                           |
...
| Agent | `applier`                   | Delegating a spec-tree apply work item to an isolated implementation runner                                                                                                                                                                                                                                                                                 |
...
| Agent | `implementation-auditor`    | ALWAYS invoke for implementation audits over code, tests, and architecture in a changeset scope                                                                                                                                                                                                                                                             |
...
| Skill | `/audit-typescript-tests`            | TypeScript test-evidence audit methodology composed by a dispatched test-evidence-auditor or implementation-auditor for the TypeScript tests in scope                       |
