...
| Skill | `/test`                       | Writing or repairing deterministic tests for a spec assertion or when learning the testing approach                                                                                                                                                                                                                                                             |
...
| Skill | `/verify`                     | Selecting or establishing evidence for spec assertions or a spec-tree scope                                                                                                                                                                                                                                                                                     |
