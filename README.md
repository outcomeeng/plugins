...
| Skill   | `/managing-pr`                | Managing an open pull request after PR creation — inspecting review and check state, classifying review feedback, posting findings, pushing follow-up commits, or deciding the next PR lifecycle action                                                                                                                                      |
...
| Skill   | `/reviewing-changes`          | The wrapper agent reviews the working changes on a branch against the PR's base ref                                                                                                                                                                                                                                                          |
| Skill   | `/reviewing-pr`               | Asked by the user to invoke the PR review skill                                                                                                                                                                                                                                                                                              |
| Skill   | `/standardizing-merging`      | Cross-cutting standards for the merge flow — branch hygiene, branch topology, push semantics, draft/ready lifecycle, heartbeat protocol, three-surface review inspection, and the four-class review-finding taxonomy used by both authors and reviewers                                                                                      |
| Skill   | `/testing`                    | Writing tests or when learning the testing approach                                                                                                                                                                                                                                                                                          |
| Skill   | `/thread-store`               | Persisting or retrieving branch-scoped vetting records                                                                                                                                                                                                                                                                                       |
...
| Agent   | `changes-reviewer`            | Reviewing working changes on the current branch against an explicit base ref                                                                                                                                                                                                                                                                 |
