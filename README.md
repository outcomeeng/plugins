...
| Skill | `/understand`                 | The live SPEC_TREE_FOUNDATION marker is absent before directly reading, searching, listing, or changing product content: source, tests, evals, generated output, specs, decisions, coordination notes, or spec-declared configuration                                                                                                                           |
