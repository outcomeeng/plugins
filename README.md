...
| Skill | `/audit`                    | Implementation-audit orchestration methodology preloaded by the implementation-auditor agent                                                                                                                                                                                                                                                                |
...
| Agent | `applier`                   | Running spec-tree /apply through implementation with architecture and test audit gates after the user passes --agent to /apply                                                                                                                                                                                                                              |
