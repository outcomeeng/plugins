...
| Skill   | `/handoff`               | Closing an in-scope spec-tree session, deciding whether to create a session file, writing a session file, or preparing continuation context                                                                                                                                                                                                  |
...
| Skill   | `/pr`                    | The user asks to ship, open or manage a PR, merge, or runs /pr                                                                                                                                                                                                                                                                               |
