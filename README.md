...
| Skill | `/audit-implementation`     | Implementation-audit orchestration methodology preloaded by the implementation-auditor agent                                                                                                                                                                                                                                                                    |
...
| Skill | `/open-pr`                  | PR opening protocol for VERIFICATION_READINESS, branch push, ready peer or draft stacked PR creation, and first management pass                                                                                                                                                                                                                                 |
...
| Skill | `/review-changes`           | Changeset-review methodology preloaded by the changes-reviewer agent                                                                                                                                                                                                                                                                                            |
...
| Skill | `/code-typescript`                   | Writing or fixing implementation code for TypeScript, or when remediating TypeScript implementation findings from a reviewer or auditor                                     |
