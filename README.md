...
| Skill | `/upstream`               | ALWAYS invoke this skill to establish the contribution target for a repository the operator does not control — the upstream a fork came from, the head to push from, and the operator's permission on it |
