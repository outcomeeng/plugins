...
| Agent   | `changes-agent`               | Reviewing working changes on the current branch against a base ref                                                                                                                                                                                                                                                                           |
...
| Command | `/vet-changes-review`         | Vet working changes via the LLM review lens                                                                                                                                                                                                                                                                                                  |
