...
| Type  | Name                      | Purpose                                                                                                                                                                                                        |
| ----- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Skill | `/audit-copy`             | Copy audit methodology — sweeps self-contained pieces against the base catalog and the copy composition layer — composed by audit-prose for the copy kind                                                      |
| Skill | `/audit-docs`             | Docs audit methodology — sweeps documentation against the base catalog and the simplified ASD-STE100 structural rules — composed by audit-prose for the docs kind                                              |
| Skill | `/audit-interface`        | Interface audit methodology — sweeps surface text against the base catalog, the fragment and consistency overrides, and the interface rules — composed by audit-prose for the interface kind                   |
| Skill | `/audit-internal-docs`    | Internal-doc audit methodology — sweeps workspace documents against the base catalog, the internal-doc overrides, and the internal-doc rules — composed by audit-prose for the internal-docs kind              |
| Skill | `/audit-prose`            | Prose audit methodology preloaded by the prose-auditor agent                                                                                                                                                   |
...
| Skill | `/author-docs`            | Docs authoring guidance — tutorials, how-tos, reference, and conceptual guides in simplified ASD-STE100 — composed by author-prose for the docs kind                                                           |
...
| Skill | `/author-internal-docs`   | Internal-doc authoring guidance — Notion pages, runbooks, scorecards, policies, onboarding guides, and workspace decision records — composed by author-prose for the internal-docs kind                        |
...
| Skill | `/docs-standards`         | Standards for the docs kind — documentation that explains or instructs the use of a product: tutorials, how-tos, reference, conceptual guides                                                                  |
