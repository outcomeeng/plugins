...
allowed-tools: Read, Glob, Grep, Skill, Agent, Bash(python3 "${CLAUDE_SKILL_DIR}/../contribution-standards/scripts/resolve_target.py":*), Bash(gh issue view:*), Bash(gh issue list:*), Bash(gh issue comment:*), Bash(gh issue close:*), Bash(gh api:*), Bash(git rev-parse:*), Bash(git log:*), Bash(printf:*)
---
