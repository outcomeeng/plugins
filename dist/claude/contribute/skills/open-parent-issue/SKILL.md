...
allowed-tools: Read, Glob, Skill, Agent, AskUserQuestion, Bash(python3 "${CLAUDE_SKILL_DIR}/../contribution-standards/scripts/resolve_target.py":*), Bash(gh issue create:*), Bash(gh search issues:*), Bash(git log:*), Bash(printf:*)
---
