...
<objective>
A structured verdict on one subagent configuration file against the `create-subagent` and `/agent-prompt-standards` conventions, with every finding naming its location, governing convention, and consequence.
</objective>
