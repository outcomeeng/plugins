...
Render one representative instance, verify that no unresolved placeholder remains, run the target repository's canonical skill checks, and obtain a fresh typed `instructions:skill-auditor` verdict over the complete bundle.
