...
Invoke the `instructions:skill-standards` skill before structuring the body; its XML structure principles and token-efficiency rules apply unchanged to subagents.
</critical_rule>
</configured_agent_xml_structure>
