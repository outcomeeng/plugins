...
- **The audit path runs at the craft model tier.** The `prose-auditor` agent, the `audit-prose` router, and the four composed audit skills declare the explicit Strong model profile.
