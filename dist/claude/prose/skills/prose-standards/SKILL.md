...
2. **Audience.** The reader is a team colleague with working context — one who skims and may return to a specific section later, wherever the team keeps the document, a workspace tool or a repository? Kind: **internal-docs** -> `/internal-docs-standards`.
