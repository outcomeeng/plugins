...
Use common verbs. Vary sentence openings. One rhetorical move per paragraph. Say it once well. Length matches substance. Zero tolerance for patterns in `/prose-standards` -- never use any of them, not even once.
...
- Verbs are common and precise
- Adverbs add real information, not emphasis
- Sentence openings vary
- Each paragraph develops a thought, not just segments one
- Claims are scoped to what the text demonstrates
- Sources are named or the sentence stands on its own evidence
...
- Zero instances of any pattern from `/prose-standards` -- no negative parallelism, no authenticity adverbs, no asserting significance, none of them
