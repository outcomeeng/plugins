...
allowed-tools: Read, Grep, Glob, Bash(pwd), Bash(spx --version:*), Bash(spx session handoff:*), Bash(spx -C:* session handoff*), Bash(claude plugin marketplace list:*), Bash(python3:*), Bash(printf:*), Bash(echo:*), AskUserQuestion
---
