...
- MUST run consumer-defined commands from `CLAUDE.md` or `spx/local/merging.md` through normal tool approval when they fall outside the narrow Bash grants in frontmatter; never widen `allowed-tools` during execution.
