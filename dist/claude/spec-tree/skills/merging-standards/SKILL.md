...
- review inspection, classification, action tokens, check waits, merge cleanup, failure modes, and success criteria.

The composing skill names the tagged section it needs. Read this one-level reference and apply that section without reimplementing it.
