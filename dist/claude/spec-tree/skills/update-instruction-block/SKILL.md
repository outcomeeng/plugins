...
allowed-tools: Bash(python3 "${CLAUDE_SKILL_DIR}/scripts/instruction_block.py":*), Bash(git log:*), Bash(git rev-parse:*), Bash(git -C:* rev-parse --show-toplevel), Read, Skill, Edit, AskUserQuestion
---
