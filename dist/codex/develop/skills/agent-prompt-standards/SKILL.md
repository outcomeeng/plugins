...
<objective>
The agent-prompt writing conventions — voice, description style, constraint language, objective shape, and anti-patterns — for the text within SKILL.md files and subagent developer instructions, enforced across every creator and auditor skill.
</objective>
