...
Read `/agent-prompt-standards` for voice, description, constraint, and anti-pattern conventions before writing prompt text.
</objective>
...
**Writing effective prompts**: [${SKILL_DIR}/references/write-subagent-prompts.md](references/write-subagent-prompts.md)
