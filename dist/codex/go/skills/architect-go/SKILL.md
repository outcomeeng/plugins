...
- `AGENTS.md` - Product navigation, work item status, sparse integer index dependencies
...
| File                                       | Purpose                                                        |
| ------------------------------------------ | -------------------------------------------------------------- |
| `${SKILL_DIR}/references/adr-patterns.md`  | Common ADR patterns for Go                                     |
| `${SKILL_DIR}/references/go-principles.md` | Packages, type-driven design, errors, concurrency, and modules |
