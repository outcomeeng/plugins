...
- `${SKILL_DIR}/references/false-positive-handling.md` -- when a surprise is legitimate in Go context
- `${SKILL_DIR}/references/concurrency-soundness.md` -- soundness pass for goroutines, channels, mutexes, and context
- `${SKILL_DIR}/references/unsafe-cgo-soundness.md` -- soundness pass for `unsafe` conversions and cgo boundaries
- `${SKILL_DIR}/references/example-audit.md` -- complete PASS and FAIL examples
