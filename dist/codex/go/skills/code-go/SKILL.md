...
<bundled_files>
References live at `${SKILL_DIR}/references/` and workflows at `${SKILL_DIR}/workflows/`; the loading message supplies that base directory. Do not search the product directory for skill files.
</bundled_files>
...
- `${SKILL_DIR}/references/outcome-engineering-patterns.md` -- Go-native code patterns for seams, config, errors, and cleanup
- `${SKILL_DIR}/references/test-patterns.md` -- debuggability-first Go test organization
