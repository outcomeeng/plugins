...
Read `references/vhdl-idioms.md` first, then follow `workflows/vhdl-review.md` exactly.

| User Provides   | Reference to Read           | Additional Context                       |
| --------------- | --------------------------- | ---------------------------------------- |
| Design files    | `references/vhdl-idioms.md` | Full review against all idiom categories |
| Package files   | `references/vhdl-idioms.md` | Focus on type discipline, naming         |
| Testbench files | `references/vhdl-idioms.md` | Testbench-specific idioms apply          |
| Mixed           | `references/vhdl-idioms.md` | Review each file in its appropriate mode |
...
| File                        | Purpose                                           |
| --------------------------- | ------------------------------------------------- |
| `references/vhdl-idioms.md` | Comprehensive idiomatic VHDL-2008 reference       |
| `workflows/vhdl-review.md`  | Step-by-step review procedure with finding format |
