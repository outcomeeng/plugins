...
| Variable inputs, abstraction, reusable domain design            | `${SKILL_DIR}/references/reusability-patterns.md` |
| Files, data, external services, mutation, executable automation | `${SKILL_DIR}/references/technical-patterns.md`   |
| Activation, routing, output, failure, or fresh-context testing  | `${SKILL_DIR}/references/test-patterns.md`        |
