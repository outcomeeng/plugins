...
allowed-tools: Read, Glob, Grep, Write, Edit, Agent, Skill, Bash(python3 "${SKILL_DIR}/scripts/quick_validate.py":*), Bash(just build-skills:*), Bash(just check-skills:*), Bash(just docs-check:*), Bash(just check:*), Bash(git status:*), Bash(git diff:*), Bash(git add:*), Bash(git commit:*)
---
