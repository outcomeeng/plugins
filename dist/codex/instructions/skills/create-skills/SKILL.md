...
allowed-tools: Read, Glob, Grep, Write, Edit, Agent, Skill, Bash(python3 "${SKILL_DIR}/scripts/quick_validate.py":*), Bash(git status:*), Bash(git diff:*), Bash(git add:*), Bash(git commit:*)
---
