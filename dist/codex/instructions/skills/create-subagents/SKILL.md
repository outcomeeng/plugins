...
How to avoid: Keep this SKILL.md under 500 lines; move extended examples and configuration matrices to the cited references, then run `wc -l "${SKILL_DIR}/SKILL.md"` before audit.
