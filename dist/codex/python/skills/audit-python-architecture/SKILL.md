...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete REJECTED review showing all concern types: SaaS `l2` violation, mocking language, missing testability in `## Verification`, and temporal voice violations.
</example_review>
