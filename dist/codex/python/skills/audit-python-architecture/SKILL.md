...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete REJECTED review showing the Python concern types: SaaS `l2` violation, mocking language, and missing testability in `## Verification`.
</example_review>
