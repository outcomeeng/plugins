...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete ADR-target `FAIL` JSON verdict showing the Python concern types: SaaS `l2` violation, mocking language, and missing testability in `## Verification`.
</example_review>
