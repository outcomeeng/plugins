...
2. Invoke `spec-tree:audit` with that changeset scope and live file list unchanged.
...
- `spec-tree:audit` ran in this isolated context over the caller's exact changeset scope and live file list when supplied.
