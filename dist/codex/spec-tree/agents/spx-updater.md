...
name: spx-updater
description: >-
  ALWAYS invoke when applying spec-tree template drift to a product's root CLAUDE.md and AGENTS.md managed guide sections in the background — it runs the /update-spx skill autonomously to regenerate stale guide sections from the installed template. NEVER put update logic here; it only invokes the skill.
