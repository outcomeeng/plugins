...
Invoke `spec-tree:change-standards` with `Sliced`; it loads the common record contract and the cumulative Sliced Definition of Ready only. Read `${SKILL_DIR}/templates/change.md` and the router's store configuration.
