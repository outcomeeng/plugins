...
- `AGENTS.md` and `CLAUDE.md` contain current managed Spec Tree sections scoped to the product's enabled languages while preserving independent product instructions.
