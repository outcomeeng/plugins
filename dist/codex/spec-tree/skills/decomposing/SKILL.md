...
- `${SKILL_DIR}/../understanding/references/what-goes-where.md` — artifact content taxonomy and test-infrastructure governance and placement rules (`<test_infrastructure>`)
...
2. Create `{slug}.md`.
3. Use the enabler or outcome template from `${SKILL_DIR}/../understanding/templates/nodes/`.
