...
5. `${SKILL_DIR}/workflows/05-change.md` — when `spx/local/coordination.md` exists, post the Handoff on each held Change and release it, or close it as Applied, Refined, or Abandoned, in place of 04's session-file and archive steps
