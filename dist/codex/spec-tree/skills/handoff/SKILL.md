...
allowed-tools: Read, Edit, Write, Bash(spx session:*), Bash(git status:*), Bash(git branch:*), Bash(git push:*), Bash(git switch:*), Bash(git symbolic-ref:*), Bash(pwd), Bash(ls:*), request_user_input, Glob, Grep, Skill
---
