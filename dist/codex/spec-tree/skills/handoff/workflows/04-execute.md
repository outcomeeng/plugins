...
When `spx/local/coordination.md` exists, `${SKILL_DIR}/workflows/05-change.md` replaces this section — see `SKILL.md` `<change_coordination>`.
...
When `spx/local/coordination.md` exists, `${SKILL_DIR}/workflows/05-change.md` replaces this section for held Changes; legacy `<CLAIMED_SESSIONS>` ids still archive here — see `SKILL.md` `<change_coordination>`.
