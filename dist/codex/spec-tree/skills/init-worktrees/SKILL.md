...
allowed-tools: Read, Bash(git:*), Bash(python3:*), Bash(just:*), Bash(pnpm:*), request_user_input
---
...
```bash
python3 "${SKILL_DIR}/scripts/init_worktrees.py" classify --path .
```
...
```bash
python3 "${SKILL_DIR}/scripts/init_worktrees.py" provision \
...
```bash
python3 "${SKILL_DIR}/scripts/init_worktrees.py" classify --path <main_worktree>
```
