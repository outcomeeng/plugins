...
allowed-tools: Skill, request_user_input, Bash(git branch:*), Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(gh repo view:*), Bash(gh pr view:*), Bash(head:*), Bash(echo:*), Read
---
