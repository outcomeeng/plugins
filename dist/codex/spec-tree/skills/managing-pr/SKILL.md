...
- Every follow-up push runs the project's full deterministic-verification command and re-runs /standardizing-merging `<branch_hygiene>`, and goes to the ready PR with no draft toggle.
