...
- Every gate decision a transport reports names the `<authority_gates>` predicates in `${SKILL_DIR}/references/merge-policy.md` it read and the observable state each predicate held.
