...
- Every merge-lifecycle git operation stays inside the assigned worktree. Advancing another checkout that holds the base branch is environment maintenance a repository declares as a release action in its overlay, never a step this policy performs.
