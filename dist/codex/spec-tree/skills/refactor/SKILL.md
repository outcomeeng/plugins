...
- `${SKILL_DIR}/../understand/references/what-goes-where.md` — content taxonomy (what belongs where)
- `${SKILL_DIR}/../understand/references/node-types.md` — enabler vs outcome
