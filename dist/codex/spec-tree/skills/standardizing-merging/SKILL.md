...
<objective>
Defines the concepts, predicates, gates, commands, and tokens shared by the merge lifecycle — /merge as dispatcher, /github-pr as router, /opening-pr as the one-shot opening protocol, and /managing-pr as the open-PR managing protocol. Carries no flow itself; ships vocabulary only.
</objective>
