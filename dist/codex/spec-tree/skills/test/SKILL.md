...
allowed-tools: Read, Glob, Grep, Write, Edit, Skill, Bash(git mv:*), request_user_input
---
...
**PREREQUISITE**: Read `${SKILL_DIR}/references/methodology.md` before selecting evidence or writing any test.
