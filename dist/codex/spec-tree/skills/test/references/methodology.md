...
Framework mocks are forbidden. If call recording is required, supply a recording collaborator through dependency injection and assert against its recorded observations in the linked test.
