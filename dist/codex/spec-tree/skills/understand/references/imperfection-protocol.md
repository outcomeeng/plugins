...
A safe local fix is applied immediately without asking. A blocking decision is surfaced via `request_user_input` immediately. A non-blocking decision is held until the next natural checkpoint.
