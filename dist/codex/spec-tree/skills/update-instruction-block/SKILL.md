...
allowed-tools: Bash(python3 "${SKILL_DIR}/scripts/instruction_block.py":*), Bash(git log:*), Bash(git rev-parse:*), Read, Skill, apply_patch, request_user_input
---
