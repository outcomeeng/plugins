...
- Encode the appropriate assertion type and level (`l1`/`l2`/`l3`)
...
Follow established coding standards from AGENTS.md including:
...
5. **Load standards** - Read product AGENTS.md if present; fall back to TypeScript best practices if absent
