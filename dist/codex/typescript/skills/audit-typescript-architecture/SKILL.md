...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete REJECTED review showing the TypeScript concern types: missing testability in `## Verification`, mocking language, and SaaS `l2` violation.
</example_review>
