...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete ADR-target `FAIL` JSON verdict showing the TypeScript concern types: missing testability in `## Verification`, mocking language, unjustified test-double language, and SaaS `l2` violation.
</example_review>
