...
<example_review>
Read `${SKILL_DIR}/references/example-audit.md` for a complete REJECTED review showing all concern types: phantom Testing Strategy section, missing testability in `## Verification`, mocking language, and temporal voice violations.
</example_review>
