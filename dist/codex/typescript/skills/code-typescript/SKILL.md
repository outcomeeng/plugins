...
Read: AGENTS.md; README.md and CONTRIBUTING.md only when present;
...
| Input                                         | Mode               | Workflow                                   |
| --------------------------------------------- | ------------------ | ------------------------------------------ |
| ADR, PDR, or spec-tree node                   | **Implementation** | `${SKILL_DIR}/workflows/implementation.md` |
| Design note, ticket, or direct user request   | **Implementation** | `${SKILL_DIR}/workflows/implementation.md` |
| Rejection feedback from a reviewer or auditor | **Remediation**    | `${SKILL_DIR}/workflows/remediation.md`    |
