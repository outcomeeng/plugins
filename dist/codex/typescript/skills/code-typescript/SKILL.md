...
Move domain-significant string and number literals whose meaning can drift to semantically named module-level constants. Keep typed literals inline when extraction adds no domain meaning, following `${SKILL_DIR}/references/vocabulary-registry-pattern.md`.
...
Read: README.md, docs/, AGENTS.md, CONTRIBUTING.md
...
| --------------------------------------------------- | ------------------------------------------------------------------------------- |
| What conventions govern this work?                  | Read the relevant skill, spec, ADR/PDR, `AGENTS.md`, and product docs first     |
...
**Authority rule**: Skills, specs, ADRs/PDRs, `AGENTS.md`, and product docs answer "how should this be done?" Code search answers only "where is the existing artifact I should reuse?"
...
| Input                            | Mode               | Workflow                                   |
| -------------------------------- | ------------------ | ------------------------------------------ |
| Spec (ADR/PDR, node spec)        | **Implementation** | `${SKILL_DIR}/workflows/implementation.md` |
| Rejection feedback from reviewer | **Remediation**    | `${SKILL_DIR}/workflows/remediation.md`    |
...
| File                                                      | Purpose                               |
| --------------------------------------------------------- | ------------------------------------- |
| `${SKILL_DIR}/references/outcome-engineering-patterns.md` | Subprocess, resource cleanup, config  |
| `${SKILL_DIR}/references/test-patterns.md`                | Debuggability-first test organization |
| `${SKILL_DIR}/references/verification-checklist.md`       | Pre-submission verification           |
| `${SKILL_DIR}/references/vocabulary-registry-pattern.md`  | Closed vocabulary source-of-truth     |
...
| Workflow                                   | Purpose                         |
| ------------------------------------------ | ------------------------------- |
| `${SKILL_DIR}/workflows/implementation.md` | TDD phases, code standards      |
| `${SKILL_DIR}/workflows/remediation.md`    | Fix issues from review feedback |
