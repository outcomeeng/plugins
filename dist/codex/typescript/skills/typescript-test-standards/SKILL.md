...
| `${SKILL_DIR}/references/exception-implementations.md` | Implementing a Stage 5 exception from `/test`                 |
| `${SKILL_DIR}/references/l2-patterns.md`               | Writing tests that require real infrastructure (Docker, etc.) |
| `${SKILL_DIR}/references/l1-local-deterministic.md`    | Applying the complete Level 1 evidence contract               |
| `${SKILL_DIR}/references/l2-local-infrastructure.md`   | Applying the complete Level 2 evidence contract               |
| `${SKILL_DIR}/references/l3-remote-credentialed.md`    | Applying the complete Level 3 evidence contract               |
