...
| [`skills/skill-structure-migration.md`](skills/skill-structure-migration.md) | Migration path from legacy `.capability/.feature/.story` subtrees to the current `.enabler/.outcome` taxonomy                             | When porting a project from `spx-legacy` to `spec-tree`, or cleaning up residual legacy nodes            |
