...
`understand` owns the inline foundation, conditional operational references, compatibility pointers, examples, and artifact templates.
...
│   └── pdr-example.md
├── references/
│   ├── assertion-types.md       # compatibility pointer to SKILL.md
│   ├── durable-map.md           # compatibility pointer to SKILL.md
│   ├── excluded-nodes.md
│   ├── imperfection-protocol.md # compatibility pointer to SKILL.md
│   ├── node-types.md            # compatibility pointer to SKILL.md
│   ├── ordering-rules.md        # compatibility pointer to SKILL.md
│   ├── product-domain-shapes.md
│   ├── verification-kinds.md    # compatibility pointer to SKILL.md
│   └── what-goes-where.md
└── templates/
    ├── product/
    │   └── product-name.product.md
