...
each plugin listed there, walks the plugin directory to collect:

  - skills from ``plugins/<name>/skills/*/SKILL.md``
  - agents from ``plugins/<name>/agents/*.md``
  - commands from ``plugins/<name>/commands/*.md``
