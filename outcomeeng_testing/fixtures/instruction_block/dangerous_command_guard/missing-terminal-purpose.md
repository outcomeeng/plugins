...
- When no sanctioned operation exists, abandon the goal, report the blocked command with secrets redacted, explain the guard's reason, ask the operator for direction, and stop.
