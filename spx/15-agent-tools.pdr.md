...
- NEVER: host-readiness guidance polls an active waiter or starts another waiter after absent or malformed output or any terminal result other than `not_ready`; absent or malformed terminal output blocks for the operator ([audit])
