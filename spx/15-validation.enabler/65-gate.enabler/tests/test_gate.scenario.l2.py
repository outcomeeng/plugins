...
def test_signal_terminates_process_group_within_grace() -> None:
    observations = observe_signals_terminate_process_groups_within_grace()
    ...
    for observation in observations:
        ...
        assert isinstance(observation.summary, dict)
        summary = cast(dict[str, object], observation.summary)
...
def test_signal_during_production_spawn_reaches_child_group() -> None:
    observations = observe_spawn_window_signals_reach_child_groups()
