...
- ALWAYS: interface surfaces that instruct Claude to call external tools present payload command forms by supported harness environment, per `spx/15-agent-tools.pdr.md` ([audit])
