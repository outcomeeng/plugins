...
- ALWAYS: `{!% include 'path/to/file.md' %!}` inlines the named file's body verbatim into the rendered output — short shared fragments expand inline ([test](tests/test_render_text.scenario.l1.py))
