...
- ALWAYS: source-tree validation treats a skill directory containing only `__pycache__` files as absent; a skill directory containing authored source without `SKILL.md` fails validation ([test](tests/test_source_and_templating.compliance.l1.py))
