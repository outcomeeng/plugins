...
- NEVER: agent conversion writes generated agents into published Codex plugin manifest content - custom agents install through the checkout's local Codex configuration under `.codex/agents/` ([test](tests/test_agents.compliance.l1.py))
