...
- Run selection is evidence-based: every workflow summary names the user-provided identifier (run id, PR, branch, commit) or the default rule (active branch + HEAD) used to select the run ([test](tests/test_runtime_operations.mapping.l1.py))
