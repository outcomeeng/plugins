...
- ALWAYS: an agentic verification run derives its changeset scope — branch, slug, base ref, changed-file set — through the shared changeset-scope primitives (`spx/21-spec-tree.enabler/16-verification.enabler/15-changeset-scope.enabler/scope-changeset.md`) ([audit])
