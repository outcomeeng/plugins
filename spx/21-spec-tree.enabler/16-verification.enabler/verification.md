...
- NEVER: a wrapper agent omits the model identifier or declares `model: inherit` — verification agents must not depend on the session model ([test](tests/test_agent_model_field.mapping.l1.py))
