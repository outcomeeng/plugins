...
- ALWAYS: read all ancestor specs, lower-index sibling specs, and governing ADRs/PDRs for a target with a complete ancestor chain ([audit])
...
- ALWAYS: read every ADR/PDR returned by globs — do not filter by title relevance ([audit])
