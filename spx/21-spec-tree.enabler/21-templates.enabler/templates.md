...
- ALWAYS: the ADR and PDR decision templates require each Compliance MUST/NEVER rule to carry a single per-rule evidence-mode tag — one of scenario, mapping, conformance, property, compliance ([review])
