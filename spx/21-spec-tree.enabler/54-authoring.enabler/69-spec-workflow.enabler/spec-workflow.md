...
- NEVER: `/spec` selects an assertion's verification type or assertion type, writes tests or implementation, or treats implementation structure as the durable-map structure ([audit])
