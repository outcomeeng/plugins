...
- ALWAYS: create the product spec and the root `CLAUDE.md` and `AGENTS.md` managed Spec Tree instruction block before any top-level child nodes — the root must exist before composition ([review])
