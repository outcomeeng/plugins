...
- ALWAYS: a test-evidence rejection triggers an autonomous `/test` methodology reset over the complete assertion and evidence chain, followed by one stabilized audit rerun; repeated concrete evidence findings do not trigger an operator question while governing truth determines the repair ([audit])
