<!-- Producer-derived prompt template for the audit-specs prose-coupling eval. -->
...
Probe focus: prose-coupling rejection and parseable-contract allowance for the `audit-specs` verdict contract.
