...
- ALWAYS: reject an audit dispatched before the assertion-relevant production owner exists with a named audit-eligibility finding; the authoring workflow defers specified-node audit until implementation makes the full chain inspectable ([audit])
