...
- ALWAYS: each `audit-{lang}-architecture` concern skill accepts composition by `implementation-auditor` for implementation architecture scope and by the decision-record auditor for ADR language-specific architecture concerns ([audit])
