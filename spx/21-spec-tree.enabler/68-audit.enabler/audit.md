...
- ALWAYS: a representative typed `implementation-auditor` run records implementation-audit input, scope, findings, terminal state, and a sealed rendered projection through the published `spx verification run` lifecycle ([audit])
