...
- `spx hooks session-start` does not mkdir the per-runtime directory. It is created lazily on first claim.
...
- Session-directory lazy-create contract: [`session-directory.md`](../13-agent-environment.enabler/43-session-directory.enabler/session-directory.md)
