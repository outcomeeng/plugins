...
PROVIDES Outcome Engineering governance for deterministic eval evidence — suite, case, trial, and verdict semantics, grading, and eval-record ownership
SO THAT methodology evals, plugin skill evals, and language-specific eval standards
CAN prove `[eval]`-tagged assertions by scoring real runtime behavior deterministically against curated cases
