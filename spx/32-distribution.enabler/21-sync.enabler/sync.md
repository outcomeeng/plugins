...
PROVIDES marketplace sync orchestration bounded to the invocation checkout — detecting whether the checkout's committed plugin distribution content changed since a base reference and running the checkout's validation accordingly
