...
The HDL plugin contains `/review-vhdl` (VHDL-2008 review with synthesizability analysis) and `/review-systemverilog` (IEEE 1800-2017 review for Vivado and Quartus).
