...
- NEVER: a skill names, describes, detects, constrains, refuses, branches on, or otherwise depends on its caller — context placement and dispatch policy belong to the caller ([review])
