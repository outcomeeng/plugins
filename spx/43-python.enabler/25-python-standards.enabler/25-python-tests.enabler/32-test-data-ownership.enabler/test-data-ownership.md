...
- NEVER: create shared test-owned constants such as `TEST_FIXTURES`, `SAMPLE_PATHS`, `TYPICAL`, or `EDGES` to satisfy magic-value or literal checks — named example bags preserve hand-picked values ([review])
