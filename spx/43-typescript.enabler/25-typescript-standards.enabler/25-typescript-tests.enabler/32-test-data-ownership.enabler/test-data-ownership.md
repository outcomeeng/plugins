...
- NEVER: declare variables or constants inside executed TypeScript test files; every value or configuration choice those declarations would bind lives in source contracts, spec-governed harnesses, spec-governed generators, inert fixtures, or justified eval case data ([review])
