...
- NEVER: create a TypeScript constant bag named `TEST_FIXTURES`, `SAMPLE_PATHS`, `TYPICAL`, or `EDGES` standing in for source-owned values — moving a hand-picked value behind a name adds no evidence ([eval](evals/shared-constant-bag/eval.toml))
