...
- NEVER: place execution-lane or methodology rules under this enabler — those are governed by `spx/14-verification.pdr.md` and the spec-tree methodology references; this enabler scopes only TypeScript-specific concerns ([review])
