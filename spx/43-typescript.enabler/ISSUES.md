...
- `typescript-architecture-standards/SKILL.md` includes `<adr_sections>` and `<atemporal_voice>` sections that duplicate `spx/21-spec-tree.enabler/spec-tree.md` and `src/plugins/spec-tree/skills/understand/SKILL.md` `<atemporal_voice>`.
