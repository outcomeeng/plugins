...
Marketplace installation changes include `just verify-marketplace-installation` in the focused deterministic scope. This command runs the installation subtree's complete pytest-discovered evidence in disposable homes and performs no persistent installation.
