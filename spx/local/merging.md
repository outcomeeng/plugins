...
Marketplace installation changes include `just verify-marketplace-installation` in the focused deterministic scope. This command runs the exact repository-installation L3 test in disposable homes and performs no persistent installation.
