...
- Repository-scoped marketplace synchronization and install verification that leave user-global runtime state untouched, governed by `spx/15-marketplace-state.adr.md`
