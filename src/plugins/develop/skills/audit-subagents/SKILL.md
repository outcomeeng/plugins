...
description: >-
  {{! term('configured_agent') | capitalize !}}-configuration audit methodology preloaded by the subagent-auditor agent.
  Dispatch subagent-auditor to audit {{! term('configured_agent') !}} configuration files; the main
