...
{!% require_skill 'develop:standardizing-agent-prompts' %!}

{!% require_skill 'develop:creating-subagents' %!}
...
1. Read best practices from the creating-subagents skill and its reference files
