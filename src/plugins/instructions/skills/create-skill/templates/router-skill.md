...
| Response          | Workflow                                               |
| ----------------- | ------------------------------------------------------ |
| 1, "{{keywords}}" | `${CLAUDE_SKILL_DIR}/workflows/{{first-workflow}}.md`  |
| 2, "{{keywords}}" | `${CLAUDE_SKILL_DIR}/workflows/{{second-workflow}}.md` |
| 3, "{{keywords}}" | `${CLAUDE_SKILL_DIR}/workflows/{{third-workflow}}.md`  |
