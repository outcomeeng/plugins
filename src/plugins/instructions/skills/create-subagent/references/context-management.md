...
1. Create scratchpad file: `{!% if target == 'codex' %!}.codex{!% else %!}.claude{!% endif %!}/scratch/debug-session-{timestamp}.md`
...
```markdown
<memory_structure>
{!% if target == 'codex' %!}.codex{!% else %!}.claude{!% endif %!}/memory/
...
1. Read `{!% if target == 'codex' %!}.codex{!% else %!}.claude{!% endif %!}/memory/architecture-state.md` for current system state
...
tools: Read, Bash
model: {{! term('configured_agent_fast_model') !}}
---
