...
The directive opening is the form `/agent-prompt-standards` `<description_style>` measures highest; it governs skill and {{! term('configured_agent') !}} descriptions alike.
</clear_triggers>
