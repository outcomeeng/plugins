...
allowed-tools: Read, Write, Glob, Grep, Edit, Skill{!% if target == 'claude' %!}, Bash(cargo fmt:*), Bash(cargo clippy:*), Bash(cargo check:*), Bash(cargo test:*){!% endif %!}
---
...
- `README.md`, `docs/`, `{{! file('root_guide') !}}`, and `CONTRIBUTING.md` when present
