...
- **Producer-coupled evals name their prompt template.** The canonical eval lane admits the eval-relative producer prompt template an eval declares, beside `eval.toml`, `cases.jsonl`, `prompt.md`, and `history.jsonl`.
