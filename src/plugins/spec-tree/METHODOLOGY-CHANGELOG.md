...
- **`[review]` as an assertion tag.** It remains readable through edition 3 as the legacy spelling of `[audit]`, and is **removed in edition 4**. Convert `[review]` to `[audit]` before adopting edition 4.
