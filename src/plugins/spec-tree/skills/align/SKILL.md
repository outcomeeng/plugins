...
- **Unrecognized assertion type**: Assertion heading not in the five types defined by the live `/understand` `<assertion_types>` section (Scenarios, Mappings, Conformance, Properties, Compliance)
