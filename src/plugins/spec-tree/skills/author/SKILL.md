...
Use `{{! tool('ask_user') !}}` for genuine gaps. Do not ask about information already provided in the conversation.
...
Write the file. If `{{! file('spx_guide') !}}` doesn't exist, note that one should be created as a product guide.
