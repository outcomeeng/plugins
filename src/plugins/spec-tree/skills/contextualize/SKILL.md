...
**Guide files**: Read `{{! file('spx_guide') !}}` when present and record it in the manifest. A freshly bootstrapped tree may lack the guide; absence is normal.
