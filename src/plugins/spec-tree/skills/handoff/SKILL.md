...
| ---- | ------------------------------------------------ | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Methodology (skills, {{! file('root_guide') !}}) | Durable                    | Reusable patterns, gotchas, clarifications etc.                                                                                                                                                       |
...
4. `${CLAUDE_SKILL_DIR}/workflows/04-execute.md` — create or update coordination notes, commit, then write or omit the canonical continuation session file
