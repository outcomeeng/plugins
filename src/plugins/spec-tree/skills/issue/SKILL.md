...
allowed-tools: Read, Grep, Glob, Bash(pwd), Bash(spx --version:*), Bash(spx session handoff:*), Bash(claude plugin marketplace list:*), Bash(python3:*), Bash(printf:*), Bash(echo:*), {{! tool('ask_user') !}}
---
