...
allowed-tools: Read, Grep, Glob, Bash(pwd), Bash(spx --version:*), Bash(spx -C:* session handoff*), Bash(git -C:* branch --show-current), Bash(git -C:* rev-parse --verify refs/remotes/origin/*), {!% if target == 'codex' %!}Bash(codex plugin marketplace list:*),{!% else %!}Bash(claude plugin marketplace list:*),{!% endif %!} Bash(python3 -c:*), {{! tool('ask_user') !}}
---
