...
allowed-tools: Skill, {{! tool('ask_user') !}}{!% if target == 'claude' %!}, Bash(git branch:*), Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git rev-parse:*), Bash(gh repo view:*), Bash(gh pr view:*), Bash(head:*), Bash(echo:*), Bash(spx diagnose:*){!% endif %!}, Read
---
