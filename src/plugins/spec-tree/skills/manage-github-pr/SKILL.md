...
allowed-tools: Skill, {{! tool('ask_user') !}}, Bash(git branch:*), Bash(git status:*), Bash(git diff:*), Bash(git rev-parse:*), Bash(gh pr view:*), Bash(head:*), Bash(echo:*), Bash(just marketplace-source-root:*), Bash(spx diagnose:*), Read
---
...
- MUST follow {{! file('root_guide') !}} and the loaded skills exactly — this orchestration does not change any lifecycle stage's contract.
