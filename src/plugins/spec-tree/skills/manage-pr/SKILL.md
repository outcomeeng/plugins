...
- A wrapper invocation returns the closeout-ready packet to `/manage-github-pr`; a direct operator invocation continues remaining work and invokes `/handoff` plain when the session is complete.
