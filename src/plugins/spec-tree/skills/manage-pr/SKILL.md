...
- A reconstructed stack was triggered by the persisted exact base PR reporting merged, targets the repository default branch, is ready for review, and contains no dependency on the retired stack ref before it can produce a merged result.
