...
- The work queue fixes every valid in-scope finding the open-PR review surfaces — no deferral of in-scope work; a genuinely out-of-scope `FOLLOW-UP` is recorded in `ISSUES.md` / `PLAN.md` and tracked, not a merge blocker.
