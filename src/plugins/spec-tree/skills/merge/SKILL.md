...
allowed-tools: Skill,{!% if target == 'claude' %!} Task,{!% else %!} {{! tool('spawn_agent') !}},{!% endif %!} {{! tool('ask_user') !}}, Bash, Read
---
...
- MUST use the broad Bash grant only for exact commands declared by this workflow, the consumer's `{{! file('root_guide') !}}`, or `spx/local/merging.md`; consumer preflight and verification commands are product-defined and cannot be represented by a finite portable allowlist.
