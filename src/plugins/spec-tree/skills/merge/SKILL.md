...
allowed-tools: Skill, Agent, {{! tool('ask_user') !}}{!% if target == 'claude' %!}, Bash(git branch:*), Bash(git status:*), Bash(git symbolic-ref:*), Bash(git rev-parse:*), Bash(git diff:*), Bash(git push:*), Bash(grep:*), Bash(python3:*classify_changeset.py*), Bash(echo:*), Bash(spx diagnose:*), Bash(spx validation markdown:*), Bash(spx spec status:*){!% endif %!}, Read
---
