...
Missing fields, a dirty or changed subject, a nonzero deterministic result, a prior run token handed to a new dispatch, a conflicting writer, an objective/path mismatch, an unresolved item, or a repeated class with no amended invariant produces `VERIFICATION_DISPATCH_BLOCKED`; do not dispatch.
