...
- **the terminal full deterministic gate has passed when required** — the overlay's declared full-gate command ran after every applicable evidence audit and agentic review converged, against the current clean committed head, with no subsequent change and no concurrent heavy command.
