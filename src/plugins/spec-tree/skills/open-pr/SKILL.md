...
allowed-tools: Read, Glob, Grep, Edit, Write,{!% if target == 'claude' %!} Task,{!% else %!} {{! tool('spawn_agent') !}},{!% endif %!} Bash, Skill
---
...
Use the broad Bash grant only for exact commands declared by this workflow, the consumer's `{{! file('root_guide') !}}`, or `spx/local/merging.md`. Consumer preflight and verification commands are product-defined and cannot be represented by a finite portable allowlist.
