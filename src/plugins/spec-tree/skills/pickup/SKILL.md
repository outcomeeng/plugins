...
allowed-tools: Read, Bash(spx session todo:*), Bash(spx session pickup:*), Bash(spx session show:*), Bash(spx session release:*), Bash(spx worktree status:*), Bash(git fetch:*), Bash(git switch:*), Bash(git status:*), Bash(python3:*verify_session_claims.py*), {{! tool('ask_user') !}}, Glob, Skill
---
