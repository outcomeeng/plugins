...
- [ ] (both) When classification is not `owned_elsewhere`, post-context decision captured via `{{! tool('ask_user') !}}` response, or explicit `--auto-continue` override acknowledged
