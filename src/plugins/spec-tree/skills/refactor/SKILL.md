...
4. If ISSUES.md, or a transition-form PLAN.md, exists in the source directory, move it to the new location — they are node-local coordination notes.
...
- [ ] Coordination-note files (ISSUES.md, and a transition-form PLAN.md) moved with their node — they are node-local, not shared (do not need evidence links)
