...
- repository specs, ADRs, PDRs, PLAN.md, ISSUES.md, {{! file('root_guide') !}}, and local overlays
...
- repository policy text available from {{! file('root_guide') !}}, local overlays, or skills
