...
`${CLAUDE_SKILL_DIR}/references/product-domain-shapes.md` carries product-scope tests and optional prose.
...
`${CLAUDE_SKILL_DIR}/references/product-domain-shapes.md` carries split tests; `/decompose` owns classification, placement, and indexing.
...
`${CLAUDE_SKILL_DIR}/references/artifact-placement.md` carries test-infrastructure boundaries and the placements this taxonomy rules out.
