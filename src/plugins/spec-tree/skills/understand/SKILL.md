---
name: understand
description: ALWAYS invoke this skill at the beginning of each session and after compaction. NEVER read, create, or modify any file in this repository other than {{! file('root_guide') !}} without loading this skill and all its references first.
