...
- Operational files — everything under `spx/local/` (skill overlays and declared configuration such as `generated-sources.toml`) and `spx/EXCLUDE` — are configuration, not artifacts.
