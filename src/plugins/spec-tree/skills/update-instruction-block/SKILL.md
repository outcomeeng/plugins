...
allowed-tools: Bash(python3 "${CLAUDE_SKILL_DIR}/scripts/instruction_block.py":*), Bash(git log:*), Bash(git rev-parse:*), Read, Skill,{!% if target == 'claude' %!} Edit,{!% else %!} apply_patch,{!% endif %!} {{! tool('ask_user') !}}
---
