...
allowed-tools: Bash(python3 "${CLAUDE_SKILL_DIR}/scripts/instruction_block.py":*), Bash(git log:*), Read, {{! tool('use_skill') !}},{!% if target == 'claude' %!} Edit,{!% else %!} apply_patch,{!% endif %!} {{! tool('ask_user') !}}
---
