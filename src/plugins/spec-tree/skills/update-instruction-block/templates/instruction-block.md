...
Authorized plugins: {{! authorized_plugins('claude') | join(', ') !}}.

<!-- /harness:claude -->
<!-- harness:codex -->

Authorized plugins: {{! authorized_plugins('codex') | join(', ') !}}.
...
Launch through `{{! tool('spawn_agent', 'codex') !}}` and collect the result through the native collaboration tools.
