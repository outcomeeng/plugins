...
allowed-tools: Read, Write, Glob, Grep, Edit, Skill{!% if target == 'claude' %!}, Bash(npx vitest:*), Bash(npx tsc:*), Bash(npx eslint:*){!% endif %!}
---
...
| 2        | `{{! file('root_guide') !}}` and overlays | Product-specific workflow and local constraints            |
