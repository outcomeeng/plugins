...
Read `/testing` first when deciding what evidence to create. Read `/typescript-standards` before this reference when writing or reviewing TypeScript test code. These standards apply to all TypeScript tests.
</objective>
